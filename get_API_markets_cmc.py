...
URL_cmc1 = 'https://api.coinmarketcap.com/v1/ticker/?convert=EUR&limit=200'
...
cmc_markets = ['BTC', 'ETH', 'XRP', 'ADA', 'XLM', 'NEO', 'XEM', 'XMR', 'LSK', 'QTUM', 'OMG', 'STRAT', 'SC', 'XVG', 'RDD', 'PART', 'LTC', 'ETC', 'ZEC', 'ZEN']
